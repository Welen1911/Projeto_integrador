...
<a href="http://www.youtube.com" class=" ">
    <p class=" text-base text-center text-black hover:bg-gray-50 transition-all hover:scale-105 hover:ease-in md:mt-20 p-6 py-3 border w-72 border-black rounded-full mx-auto">
        Candidatar-se!
    </p>
</a>

<footer class="w-full mt-4 text-gray-700 bg-gray-100 body-font">
