    ...
    <h2 class="text-xl mb-6">Mais Informações do Candidato</h2>
        ...
        <div class="-mx-3 md:flex mb-6">
            <div class="md:w-full h-40 px-3 break-all">
              ...
              <textarea id="message" rows="4" class="block p-2.5 w-full text-sm bg-grey-lighter border-gray-500  rounded border " placeholder="Taca qualquer coisa ai" name="sobre"></textarea>
        ...
        <div class="-mx-3 md:flex mb-6">
          <div class="md:w-full px-3" id="">
            ...
            <div id="tagInputWrapper" class="flex flex-wrap bg-grey-lighter text-grey-darke">
              <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-gray-500 rounded py-3 px-4 mb-3" id="tagInput" type="file" name="curriculo">
            </div>
            <p class="text-grey-dark text-xs italic">Make it as long and as crazy as you'd like</p>
          </div>
      </div>
