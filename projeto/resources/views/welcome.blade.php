...
<header >
  ...
  <div class="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
    ...
    <div class="flex-grow flex flex-wrap md:pr-20 -mb-10 md:text-left text-center order-first">
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        <h2 class="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">INSTITUCIONAL</h2>
        <nav class="list-none mb-10">
          <li>
            <a href="http://www.youtube.com" a class="text-gray-600 hover:text-gray-800">Sobre nós</a>
          </li>
          <li>
            <a href="http://www.youtube.com" a class="text-gray-600 hover:text-gray-800">Política de Privacidade</a>
          </li>
          <li>
            <a href="http://www.youtube.com" a class="text-gray-600 hover:text-gray-800">Central de Ajuda</a>
          </li>
          <li>
            <a href="http://www.youtube.com" a class="text-gray-600 hover:text-gray-800">Termos</a>
          </li>
		  <li>
            <a href="http://www.youtube.com" a class="text-gray-600 hover:text-gray-800">Paceiros</a>
          </li>
		  <li>
            <a href="http://www.youtube.com" a class="text-gray-600 hover:text-gray-800">Trabalhe Conosco</a>
          </li>
        </nav>
      </div>
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        <h2 class="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">CANDIDATO</h2>
        <nav class="list-none mb-10">
          <li>
            <a href="http://www.youtube.com" a class="text-gray-600 hover:text-gray-800">Ajuda</a>
          </li>
          <li>
            <a href="http://www.youtube.com" a class="text-gray-600 hover:text-gray-800">Blog</a>
          </li>
          <li>
            <a href="http://www.youtube.com" a class="text-gray-600 hover:text-gray-800">Vagas</a>
          </li>
          <li>
            <a href="http://www.youtube.com" a class="text-gray-600 hover:text-gray-800">Guia de Cargos</a>
          </li>
		  <li>
            <a href="http://www.youtube.com" a class="text-gray-600 hover:text-gray-800">Aviso Legal</a>
          </li>
		  <li>
            <a href="http://www.youtube.com" a class="text-gray-600 hover:text-gray-800">Busca de Emprego Segura</a>
          </li>
        </nav>
      </div>
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav class="list-none mb-10">
          ...
          <li>
            <a href="http://www.youtube.com" a class="text-gray-600 hover:text-gray-800">Anunciar</a>
          </li>
          <li>
            <a href="http://www.youtube.com" a class="text-gray-600 hover:text-gray-800">Buscar candidatos</a>
          </li>
		  <li>
            <a href="http://www.youtube.com" a class="text-gray-600 hover:text-gray-800">Produtos Para Empresa</a>
          </li>
		  <li>
            <a href="http://www.youtube.com" a class="text-gray-600 hover:text-gray-800">Busca Certa</a>
          </li>
        </nav>
      </div>
    </div>
  ...
  <div class="bg-gray-100">
    <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
      <p class="text-gray-500 text-sm text-center sm:text-left">© 2023 - Empresa
      </p>
